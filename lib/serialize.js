		...
		for (let i of contact) {
			...
			list.push({
				...
				vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:${await conn.getName(num)}\nFN:${await conn.getName(
					num
				)}\nitem1.TEL;waid=${num2}:${num2}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:admin@rzkyfdlh.tech\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/rizkyfadilah8_\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`,
			});
		}
...
conn.logger = {
        ...conn.logger,
        info(...args) { console.log(chalk.bold.rgb(57, 183, 16)(`INFO [${chalk.rgb(255, 255, 255)(moment(Date.now()).format(" dddd, DD MMMM YYYY HH:mm:ss "))}]`), chalk.cyan(...args)) },
        error(...args) { console.log(chalk.bold.rgb(247, 38, 33)(`ERROR [${chalk.rgb(255, 255, 255)(moment(Date.now()).format(" dddd, DD MMMM YYYY HH:mm:ss "))}]:`), chalk.rgb(255, 38, 0)(...args)) },
        warn(...args) { console.log(chalk.bold.rgb(239, 225, 3)(`WARNING [${chalk.rgb(255, 255, 255)(moment(Date.now()).format(" dddd, DD MMMM YYYY HH:mm:ss "))}]:`), chalk.keyword('orange')(...args)) }
    }
